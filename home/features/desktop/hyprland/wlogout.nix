...
let
  ...
  catppuccinWlogoutPngIcons = pkgs.runCommand "catppuccin-wlogout-icons-mocha-blue-png"
...
in
{
  ...
  xdg.configFile."wlogout/icons/lock.png".source = "${catppuccinWlogoutPngIcons}/lock.png";
  xdg.configFile."wlogout/icons/logout.png".source = "${catppuccinWlogoutPngIcons}/logout.png";
  xdg.configFile."wlogout/icons/suspend.png".source = "${catppuccinWlogoutPngIcons}/suspend.png";
  xdg.configFile."wlogout/icons/hibernate.png".source = "${catppuccinWlogoutPngIcons}/hibernate.png";
  xdg.configFile."wlogout/icons/reboot.png".source = "${catppuccinWlogoutPngIcons}/reboot.png";
  xdg.configFile."wlogout/icons/shutdown.png".source = "${catppuccinWlogoutPngIcons}/shutdown.png";
